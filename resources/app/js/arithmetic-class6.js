/**
 * Class 6 Arithmetic — lightweight interactive examples.
 * Reuses LocalRuleNumbers (Phase 9); does not change the engine.
 * Teaching content on this page is Class 6 Arithmetic (not Fractions).
  ...
  function showResult(sol, questionText) {
    ...
    if (!sol) {
      output.innerHTML =
        ...
        '<p class="ar-result-error">Could not analyse this question. Try even or odd, prime, factors, HCF, LCM, place value, absolute value, or integer addition.</p>' +
        notice;
      output.hidden = false;
      return;
    }
