...
(function (root, factory) {
  ...
  const OPERATION_FORMULA_IDS = Object.freeze({
    ...
    bodmas: [],
    simplification: [],
    // Phase 9 — Integers (Milestone 2)
    integer_addition: ["CBSE-C7-AR-001", "CBSE-C6-AR-024"],
    integer_subtraction: ["CBSE-C7-AR-001", "CBSE-C6-AR-024"],
    integer_multiplication: ["CBSE-C7-AR-002"],
    integer_division: ["CBSE-C7-AR-002"],
    integer_bodmas: ["CBSE-C7-AR-001", "CBSE-C7-AR-002"],
    absolute_value: ["CBSE-C6-AR-022"],
    integer_compare: ["CBSE-C6-AR-024"],
    integer_order: ["CBSE-C6-AR-024"],
    // Phase 9 — Decimals (Milestone 3)
    decimal_addition: ["CBSE-C6-AR-007"],
    decimal_subtraction: ["CBSE-C6-AR-007"],
    decimal_multiplication: ["CBSE-C7-AR-003"],
    decimal_division: ["CBSE-C7-AR-004"],
    decimal_bodmas: ["CBSE-C6-AR-007"],
    decimal_compare: ["CBSE-C6-AR-007"],
    decimal_order: ["CBSE-C6-AR-007"],
    decimal_place_value: ["CBSE-C6-AR-007"],
    decimal_round: ["CBSE-C6-AR-007"],
    decimal_to_fraction: ["CBSE-C6-AR-017", "CBSE-C6-AR-018"],
    fraction_to_decimal: ["CBSE-C6-AR-017"],
    // Phase 9 — Advanced fractions, ratio, proportion, percentage (Milestone 5)
    fraction_mul: ["CBSE-C6-AR-018"],
  ...
  const FormulaCatalog = {
    ...
    resolveForOperation: function (operationKey) {
      return this.resolveIdsForOperation(operationKey).map(function (id) {
        ...
        const ref = { formulaId: id };
        if (entry) {
          ref.formulaName = entry.formulaName || entry.name || null;
        }
        return ref;
      });
    },
